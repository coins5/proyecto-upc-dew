    ...
    context 'when the request is invalid' do
      ...
      it 'returns a validation failure message' do
        expect(response.body)
          .to match(/Validation failed: Tipo usuario can't be blank, Apellidos can't be blank, Direccion can't be blank, Distrito can't be blank, Tipo documento can't be blank, Numero documento can't be blank, Fecha nacimiento can't be blank, Fecha inicio can't be blank, Talla can't be blank, Peso can't be blank, Sexo can't be blank, Esta en escalada can't be blank, Esta en entrenamiento can't be blank, Email can't be blank/)
      end
    end
  end
